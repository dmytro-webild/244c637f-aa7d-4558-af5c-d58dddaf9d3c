...
const HomePage = () => {
  ...
  return (
    <ThemeProvider defaultButtonVariant="hover-magnetic" defaultTextAnimation="background-highlight" borderRadius="pill" contentWidth="mediumSmall" sizing="medium" background="circleGradient" cardStyle="glass-elevated" primaryButtonStyle="gradient" secondaryButtonStyle="glass" headingFontWeight="normal">
      ...
      <div id="about-home" data-section="about-home"><AboutMetric title="About JONG HYUK TEXTILE CO., LTD." metrics={[{ id: "1", icon: Gauge, label: "Years of Expertise", value: "30+" }, { id: "2", icon: Award, label: "Quality Fabrics", value: "Premium" }, { id: "3", icon: Globe, label: "Export Markets", value: "6+" }]} metricsAnimation="none" useInvertedBackground={false} /></div>
      <div id="features-strengths" data-section="features-strengths"><FeatureCardTwentyFive animationType="slide-up" title="Our Core Strengths" description="Technology meets service." features={[{ title: "Silk-Like Polyester", description: "Luxurious feel.", icon: Sparkles, mediaItems: [{ imageSrc: resolvedAssets["feature-fabric-development"] }, { imageSrc: resolvedAssets["feature-quality-control"] }] }, { title: "Digital Print Fabrics", description: "High-end design.", icon: Lightbulb, mediaItems: [{ imageSrc: resolvedAssets["feature-fabric-development"] }, { imageSrc: resolvedAssets["feature-quality-control"] }] }]} textboxLayout="default" useInvertedBackground={false} /></div>
      <div id="products-home" data-section="products-home"><ProductCardTwo animationType="slide-up" title="Our Premium Fabric Collections" description="Premium collections." products={[{ id: "1", brand: "JONG HYUK", name: "Silky Polyester", price: "Inquire", rating: 5, reviewCount: "120", imageSrc: resolvedAssets["product-silky-polyester"] }, { id: "2", brand: "JONG HYUK", name: "Brocade Fabrics", price: "Inquire", rating: 5, reviewCount: "85", imageSrc: resolvedAssets["product-brocade-fabric"] }]} gridVariant="uniform-all-items-equal" textboxLayout="default" useInvertedBackground={true} /></div>
