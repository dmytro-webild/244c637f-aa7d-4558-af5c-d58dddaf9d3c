...
const HomePage = () => {
  ...
  return (
    <ThemeProvider defaultButtonVariant="hover-magnetic" defaultTextAnimation="background-highlight" borderRadius="pill" contentWidth="mediumSmall" sizing="medium" background="circleGradient" cardStyle="glass-elevated" primaryButtonStyle="gradient" secondaryButtonStyle="glass" headingFontWeight="normal">
      ...
      <div id="about-home" data-section="about-home"><AboutMetric title="About JONG HYUK TEXTILE CO., LTD." metrics={[{ icon: Gauge, label: "Years of Textile Excellence", value: "30+" }, { icon: Award, label: "Industry-Leading Durability", value: "Premium" }, { icon: Globe, label: "Global Export Footprint", value: "6+" }]} metricsAnimation="slide-up" useInvertedBackground={false} /></div>
